module github.com/open-telemetry/opentelemetry-collector-contrib/extension/kafkagroupbalancer
...
require (
	...
	go.opentelemetry.io/collector/component v1.57.1-0.20260501001745-24aecacf1c04 // indirect
