...
require github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sleaderelectortest v0.145.0
...
require (
	...
	go.opentelemetry.io/collector/extension/extensioncapabilities v0.145.1-0.20260212100729-5a059d1d6718 // indirect
